...
class Session(object):
    ...
    def overview(self):
        ...
        return {
            ...
            "query": """
                query Installation($giid: String!,$email:String!) {
                    installation(giid: $giid) {
                        giid
                        alias
                        pinCodeLength
                        activatedFeature {
                            guardian: isFeatureActivated(featureName:\"GUARDIAN\")  # noqa: E501
                        }
